        ...
        <div className='footer-container'>
            <div className='footer-top'>
                <div className='footer-logo-box'>
                    ...
                    <div className='footer-logo-text'>{'Dongs Coding Log'}</div>
                </div>
                <div className='footer-link-box'>
                    <div className='footer-email-link'>{'01ldm@naver.com'}</div>
            ...
            <div className='footer-bottom'>
                <div className='footer-copyright'>{'Copyright © Lee Dong Min. All Rights Reserved.'}</div>
            </div>
        </div>
    </div>
  )
